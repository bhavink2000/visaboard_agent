            ...
            children: [
              ...
              Padding(
                ...
                child: Container(
                  ...
                  child: Text("Available \nBalance: 70.00",style: TextStyle(color: Colors.white70,fontFamily: Constants.OPEN_SANS,fontSize: 10)),
                ),
              ),
            ],
          ),
                                  ...
                                  children: [
                                    ...
                                    index + 1 == walletD.length ? CustomPaginationWidget(
                                      ...
                                      onPageChange: (page) {
                                        ...
                                        dashboardDataProvider.fetchWalletDashboard(curentindex + 1, getAccessToken.access_token);
                                      },
                                    ) : Container(),
                                  ],
                                ),
