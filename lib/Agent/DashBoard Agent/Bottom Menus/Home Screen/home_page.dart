                          ...
                          child: TextButton(
                            ...
                            child: Card(
                              ...
                              child: Container(
                                ...
                                decoration: BoxDecoration(borderRadius: BorderRadius.circular(10),color: const Color(0xff452bce)),
                                child: Text(
                                  "Add Applicant",
                                  style: TextStyle(
                                      fontSize: 15,
                      ...
                      child: AnimationConfiguration.staggeredList(
                        ...
                        child: SlideAnimation(
                          ...
                          child: FadeInAnimation(
                            child: TextButton(
                              onPressed: () {
                                Navigator.push(context, MaterialPageRoute(builder: (context) => ApplyForms(name: 'Qucik Apply')));
                              },
                              child: Card(
                                elevation: 5,
                                shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(10)),
