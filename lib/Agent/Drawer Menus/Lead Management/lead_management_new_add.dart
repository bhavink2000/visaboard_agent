...
class _LeadManageAddNewState extends State<LeadManageAddNew> {
  ...
  List<String> listOflevelstudy = [
    ...
    'Post Graduate Diploma','Integrated Masters','Phd'
  ];
                              ...
                              Padding(
                                ...
                                child: SizedBox(
                                  ...
                                  child: DropdownButtonFormField(
                                    ...
                                    style: TextStyle(fontWeight: FontWeight.bold,fontSize: 18,fontFamily: Constants.OPEN_SANS,decoration: TextDecoration.underline),
                                    isExpanded: true,
                                    onChanged: (value) {
                                      setState(() {
                              ...
                              Padding(
                                ...
                                child: SizedBox(
                                  ...
                                  child: DropdownButtonFormField(
                                    ...
                                    items: listOflevelstudy.map((String val) {
                                      return DropdownMenuItem(
                                        value: val,
                                        child: Text(val,style: TextStyle(fontSize: 12,fontFamily: Constants.OPEN_SANS,color: Colors.black),),
                                      );
